...
class TestFilterCharactersByCategory:
    ...
    def test_filter_characters_gungan(self, driver, category_filter):
        search_page = SearchPage(driver)
        search_page.open_page()
        search_page.click_filters_button()
        search_page.click_on_a_specific_filter(loc.filter_loc_Gungan)
    ...
    def test_filter_characters_wookie(self, driver, category_filter):
        ...
        assert search_page.check_filtered_characters_is_valid(category_filter[39]) == 1
